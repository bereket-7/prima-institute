    ...
    <>
      <div className="bg-prima-charcoal pt-28 pb-16">
        <div className="container-prima">
          <span className="font-accent text-prima-gold text-sm tracking-[0.25em] uppercase mb-4 block">Reach Out</span>
          <h1 className="font-display text-4xl lg:text-6xl font-bold text-white mb-4">Contact Us</h1>
      ...
      <section className="section-padding bg-prima-ivory">
        <div className="container-prima">
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Form */}
            <div>
              <h2 className="font-display text-2xl font-semibold text-prima-charcoal mb-8">Send a Message</h2>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={title} className="flex gap-4">
                      ...
                      <div>
                        <p className="font-display font-semibold text-prima-charcoal text-sm mb-1">{title}</p>
                        <p className="text-prima-muted text-sm font-body whitespace-pre-line">{content}</p>
                      </div>
                    </div>
                  ))}
                </div>
